...
`src/main/zenchor_web/client.cljs` contains the code to start and refresh
...
application `zenchor_web.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/zenchor-web.jar
```
